...
public class BaseLoader : MonoBehaviour {
	...
	protected IEnumerator Initialize()
	{
		...
		AssetBundleManager.BaseDownloadingURL = relativePath + "/AssetBundle/" + platformFolderForAssetBundles + "/";

		Debug.Log("BaseDownloadingURL : " + AssetBundleManager.BaseDownloadingURL);
		//AssetBundleManager.BaseDownloadingURL = relativePath + "/" + KiaWearableUtil.AssetBundleRootPath + "/";
